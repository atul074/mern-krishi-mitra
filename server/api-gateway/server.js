...
// Auth & Admin Service Routes
app.use('/api/auth', authAdminProxy);
app.use('/api/admin', authAdminProxy);
...
📋 Microservices:
  🔐 Auth/Admin: ${services.authAdmin}
  📦 Product: ${services.product}
  🛒 Order: ${services.order}
  💬 Main/Chat: ${services.main}
