...
const services = {
  authAdmin: process.env.AUTH_ADMIN_SERVICE_URL || 'http://localhost:5001',
...
// Auth & Admin Service Proxy
const authAdminProxy = createProxyMiddleware({
  target: services.authAdmin,
  pathRewrite: {
    '^/api/auth': '/api/auth',
    '^/api/admin': '/api/admin'
  },
