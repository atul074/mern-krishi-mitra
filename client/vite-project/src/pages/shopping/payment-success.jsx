...
//   console.log(order_data.addressInfo.phone);
//   console.log(order_data.totalAmount);
//   console.log(order_data.orderDate);
...
function PaymentSuccessPage() {
  ...
  useEffect(() => {
    const sendSMS = async () => {
      try {
        await axios.post("http://localhost:8000/api/shop/order/sendSms", {
