...
function ShoppingHeader() {
          ...
          <div className="">
            <ul className="text-black   cursor-pointer transition-all duration-400 relative group font-semibold text-base px-3 flex md:gap-2 lg:gap-2 sm: gap-2">
                <li>
                    ...
                    <svg class="w-10 h-10  text-gray-500 " aria-hidden="true" xmlns="http://www.w3.org/2000/svg"  fill="none" viewBox="0 0 24 24">
  <path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="m21 21-3.5-3.5M17 10a7 7 0 1 1-14 0 7 7 0 0 1 14 0Z"/>
                ...
                <button onClick={handleLogout} >
                  <svg class="h-9 lg:h-10 p-2 text-gray-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16">
