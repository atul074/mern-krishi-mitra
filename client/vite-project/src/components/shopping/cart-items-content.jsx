...
function UserCartItemsContent({ cartItem }) {
  ...
  return (
    <div class="rounded-lg border border-gray-600 bg-gray-300 p-4 shadow-sm md:p-6 ">
            <div class="space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
              ...
              <div class="flex items-center justify-between md:order-3 md:justify-end">
                <div class="flex items-center">
                  ...
                  <input  type="text" id="counter-input-2" data-input-counter class="w-10 shrink-0 border-0 bg-transparent text-center text-sm font-medium text-gray-900 focus:outline-none focus:ring-0 " placeholder="" value={cartItem?.quantity} required />
            ...
            cartItem?.quantity
              ...
              <div class="w-full min-w-0 flex-1 space-y-4 md:order-2 md:max-w-md">
                <a href="#" class="text-xl font-medium text-gray-900 hover:underline ">{cartItem?.title}</a>

                <div class="flex items-center gap-4">
                  

                  <button  onClick={() => handleCartItemDelete(cartItem)} type="button" class="inline-flex items-center text-sm  text-red-600 hover:underline font-bold">
